...
class MockFiltersRepository extends Mock implements FilterRemoteRepository {}
...
void main() {
  ...
  late FilterRemoteRepository repository;

  setUp(() {
    mockHttpClient = MockHttpClient();
    repository = FilterRemoteRepository();
  });
  group('FilterViewModel Test', () {
    test('initFilters sets filters on success', () async {
      ...
      final container = ProviderContainer(
        overrides: [filterRemoteRepositoryProvider.overrideWithValue(mockRepo)],
      );
  ...
  group('FilterRepository Test', () {
    test('getFilterOptions returns filters on success', () async {
      ...
      repository = FilterRemoteRepository(client: mockHttpClient);
