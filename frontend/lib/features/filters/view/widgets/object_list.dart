...
/// A widget that displays a list of filtered objects with appropriate loading and error states.
/// Shows a message when no objects match the current filter criteria.
class ObjectList extends StatelessWidget {
  final AsyncValue<List<String>> objects;

  const ObjectList({required this.objects, Key? key}) : super(key: key);
